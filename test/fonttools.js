...
describe('fonttools validation', function() {
    ...
    describe('OTF (CFF) fonts', function() {
        ...
        it('should validate OTF (CFF) font round-trip', function() {
            // SourceSansPro is a CFF/OTF font already in test/fonts/
            ...
            const outputPath = path.join(OUTPUT_DIR, 'SourceSansPro-reexport.ttf');
