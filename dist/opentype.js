var opentype = (() => {
  ...
  __export(opentype_exports, {
    ...
    convertCFF2ToTTF: () => convertCFF2ToTTF,
    convertFontFormat: () => convertFontFormat,
    convertStaticCFFToTTF: () => convertStaticCFFToTTF,
    convertStaticTTFToCFF: () => convertStaticTTFToCFF,
    convertTTFToCFF2: () => convertTTFToCFF2,
    cubicToQuadratics: () => cubicToQuadratics,
    ...
    sanitizeFontForExport: () => sanitizeFontForExport,
    sanitizeFontForGoogleFonts: () => sanitizeFontForGoogleFonts
  });
      ...
      for (let i = 0; i < font.glyphs.length; i++) {
        ...
        for (const item of deltaArray) {
          if (item.advanceWidthDelta !== void 0 && item.advanceWidthDelta !== 0) {
            const peakValue = item.peakTuple ? item.peakTuple.length === 1 ? item.peakTuple[0] : item.peakTuple[axisIndex] : 1;
            if (peakValue === 1) {
