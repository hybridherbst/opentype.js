...
function Font(options) {
    ...
    if (!options.empty) {
        ...
        if (options.fsSelection) {
            selection = /** @type {number} */ (options.fsSelection);
        } else {
...
/** @type {import('./encoding.mjs').GlyphNames|undefined} */
