...
axisValueParsers[1] = /** @this {import('../parse.mjs').Parser} */ function axisValueParser1() {
    return {
...
axisValueParsers[2] = /** @this {import('../parse.mjs').Parser} */ function axisValueParser2() {
    return {
        axisIndex: this.parseUShort(),
        flags: this.parseUShort(),
        valueNameID: this.parseUShort(),
...
axisValueParsers[3] = /** @this {import('../parse.mjs').Parser} */ function axisValueParser3() {
    return {
        axisIndex: this.parseUShort(),
        flags: this.parseUShort(),
        valueNameID: this.parseUShort(),
...
axisValueParsers[4] = /** @this {import('../parse.mjs').Parser} */ function axisValueParser4() {
...
function makeSTATTable(STAT) {
    ...
    for (let i = 0; i < STAT.axes.length; i++) {
        ...
        resultRec.offsetToAxisValueOffsets = /** @type {number} */ (resultRec.offsetToAxisValueOffsets) + axisRecord.sizeOf();
